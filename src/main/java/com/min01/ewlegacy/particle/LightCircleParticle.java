...
public class LightCircleParticle extends LightParticle
{
    ...
    public LightCircleParticle(ClientLevel world, double x, double y, double z, double motionY, double angle) 
    {
	...
	public static class Provider implements ParticleProvider<SimpleParticleType>
	{
		...
		{
			LightCircleParticle particle = new LightCircleParticle(p_107422_, p_107423_, p_107424_, p_107425_, p_107427_, 1.0D);
