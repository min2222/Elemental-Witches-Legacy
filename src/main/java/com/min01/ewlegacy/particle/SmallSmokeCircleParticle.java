...
public class SmallSmokeCircleParticle extends SmokeParticle
{
    ...
    public SmallSmokeCircleParticle(ClientLevel world, double x, double y, double z, double motionY, double angle, SpriteSet sprites) 
    {
        super(world, x, y, z, 0.0, motionY, 0.0, 1.0F, sprites);
        this.portalPosX = x;
        this.portalPosZ = z;
	...
	public static class Provider implements ParticleProvider<SimpleParticleType>
	{
		...
		{
			return new SmallSmokeCircleParticle(p_107422_, p_107423_, p_107424_, p_107425_, p_107427_, 0.5D, this.sprites);
		}
	}
}
