...
public class LeafCircleParticle extends LeafParticle
{
    ...
    public LeafCircleParticle(ClientLevel world, double x, double y, double z, double motionY, double angle) 
    {
	...
	public static class Provider implements ParticleProvider<SimpleParticleType>
	{
		...
		{
			LeafCircleParticle particle = new LeafCircleParticle(p_107422_, p_107423_, p_107424_, p_107425_, p_107427_, 0.5D);
