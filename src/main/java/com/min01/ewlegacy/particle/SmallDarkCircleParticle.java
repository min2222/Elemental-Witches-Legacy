...
public class SmallDarkCircleParticle extends DarkParticle
{
    ...
    public SmallDarkCircleParticle(ClientLevel world, double x, double y, double z, double motionY, double angle) 
    {
        ...
        this.portalParticleScale = this.quadSize = 5.6F;
    }
