...
{
    public LightningParticle(ClientLevel level, double posX, double posY, double posZ, double motionX, double motionY, double motionZ) 
    {
	...
	public static class Provider implements ParticleProvider<SimpleParticleType>
	{
		...
		{
			LightningParticle particle = new LightningParticle(p_107422_, p_107423_, p_107424_, p_107425_, p_107426_, p_107427_, p_107428_);
