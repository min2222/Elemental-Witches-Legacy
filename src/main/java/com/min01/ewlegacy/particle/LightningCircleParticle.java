...
public class LightningCircleParticle extends LightningParticle
{
    ...
    public LightningCircleParticle(ClientLevel world, double x, double y, double z, double motionY, double angle) 
    {
