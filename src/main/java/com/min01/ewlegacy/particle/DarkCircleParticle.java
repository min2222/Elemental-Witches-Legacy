...
public class DarkCircleParticle extends DarkParticle
{
    ...
    public DarkCircleParticle(ClientLevel world, double x, double y, double z, double motionY, double angle) 
    {
        ...
        this.portalParticleScale = this.quadSize = 10.6F;
    }
	...
	public static class Provider implements ParticleProvider<SimpleParticleType>
	{
		...
		{
			DarkCircleParticle particle = new DarkCircleParticle(p_107422_, p_107423_, p_107424_, p_107425_, p_107427_, p_107428_);
