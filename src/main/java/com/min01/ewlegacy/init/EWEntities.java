...
public class EWEntities
{
	...
	public static final RegistryObject<EntityType<EntityWaterMinion>> WATER_MINION = registerEntity("water_minion", createBuilder(EntityWaterMinion::new, MobCategory.MONSTER).clientTrackingRange(80).updateInterval(3).setShouldReceiveVelocityUpdates(true));
