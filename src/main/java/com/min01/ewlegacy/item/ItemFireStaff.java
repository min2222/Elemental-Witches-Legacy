...
public class ItemFireStaff extends Item
{
    ...
    public InteractionResultHolder<ItemStack> use(Level p_41432_, Player p_41433_, InteractionHand p_41434_) 
    {
        ...
        if(p_41433_.getFoodData().getFoodLevel() > 1) 
        {
            ...
            EntityFireShot mwawCheckFire = new EntityFireShot(p_41432_, p_41433_, 1.0, 1.0, 1.0);
            mwawCheckFire.setPos(p_41433_.getX() + look.x * 1.0, p_41433_.getY() + look.y * 1.0 + p_41433_.getEyeHeight(), p_41433_.getZ() + look.z * 1.0);
            mwawCheckFire.xPower = look.x * 0.1;
            mwawCheckFire.yPower = look.y * 0.1;
            mwawCheckFire.zPower = look.z * 0.1;
            EWUtil.spawnInWorld(p_41432_, mwawCheckFire);
