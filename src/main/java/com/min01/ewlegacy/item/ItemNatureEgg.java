...
public class ItemNatureEgg extends Item
{
    public ItemNatureEgg()
    {
    ...
    public InteractionResultHolder<ItemStack> use(Level p_41432_, Player p_41433_, InteractionHand p_41434_)
    {
    	...
    	EntityNatureEgg mob = new EntityNatureEgg(EWEntities.NATURE_EGG.get(), p_41432_);
    	...
    	//TODO
    	//p_41433_.awardStat(MWAWAchievementsRegistry.naturepet1, 1);
