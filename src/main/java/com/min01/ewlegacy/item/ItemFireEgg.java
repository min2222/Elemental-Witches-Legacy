...
public class ItemFireEgg extends Item
{
    public ItemFireEgg() 
    {
    ...
    public InteractionResultHolder<ItemStack> use(Level p_41432_, Player p_41433_, InteractionHand p_41434_)
    {
    	...
    	EntityFireEgg mob = new EntityFireEgg(EWEntities.FIRE_EGG.get(), p_41432_);
    	...
    	//TODO
    	//p_41433_.awardStat(MWAWAchievementsRegistry.firepet1, 1);
