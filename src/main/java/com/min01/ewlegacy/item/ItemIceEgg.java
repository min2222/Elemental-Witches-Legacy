...
public class ItemIceEgg extends Item
{
    public ItemIceEgg() 
    {
    ...
    public InteractionResultHolder<ItemStack> use(Level p_41432_, Player p_41433_, InteractionHand p_41434_)
    {
    	...
    	EntityIceEgg mob = new EntityIceEgg(EWEntities.ICE_EGG.get(), p_41432_);
    	...
    	//TODO
    	//p_41433_.awardStat(MWAWAchievementsRegistry.icepet1, 1);
