...
public class EntityHalloweenEgg extends TamableAnimal
{
    public int TimerToHatch = 1000;
    
    public EntityHalloweenEgg(EntityType<? extends TamableAnimal> type, Level level)
    {
        super(type, level);
    ...
    {
        if(p_27584_.getAbilities().instabuild && p_27584_.isHolding(EWItems.HALLOWEEN_STAFF.get())) 
        {
            this.TimerToHatch = 3;
        }
        if(this.isTame()) 
