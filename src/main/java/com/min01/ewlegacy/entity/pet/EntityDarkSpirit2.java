...
public class EntityDarkSpirit2 extends TamableAnimal
{
    ...
    public EntityDarkSpirit2(EntityType<? extends TamableAnimal> type, Level level)
    {
        super(type, level);
        ...
        this.targetSelector.addGoal(1, new HurtByTargetGoal(this).setAlertOthers(EntityDarkSpirit2.class));
        this.setTame(true);
    }
    ...
    public void aiStep() 
    {
        ...
        {
            ElementalWitchesLegacy.PROXY.spawnParticlesWithMotion("sittingSignal", this.level, this.getX(), this.getY() + 2.8, this.getZ(), 0.0, 0.0, 0.0);
        }
    ...
    public boolean wantsToAttack(LivingEntity target, LivingEntity owner) 
    {
        ...
        {
            if(target instanceof EntityDarkSpirit2) 
            {
                EntityDarkSpirit2 entitywolf = (EntityDarkSpirit2) target;
    ...
    public InteractionResult mobInteract(Player p_27584_, InteractionHand p_27585_)
    {
        ...
        {
            if(p_27584_.isHolding(EWItems.DARK_SHARD.get()))
            {
                ...
                {
                	EntityDarkSpirit3 mob = new EntityDarkSpirit3(EWEntities.DARK_SPIRIT_3.get(), this.level);
                    mob.moveTo(this.getX(), this.getY(), this.getZ(), this.getYRot(), 0.0F);
                    if(this.getOwner() != null)
                    {
                        mob.setOwnerUUID(this.getOwnerUUID());
                    ...
                    for(Entity entity1 : list) 
                    {
                        ...
                        {
                        	//TODO
                        	//((Player)this.getOwner()).awardStat(MWAWAchievementsRegistry.darkpet4, 1);
                        }
                    }
                    this.discard();
                }
    ...
    public void addAdditionalSaveData(CompoundTag compound) 
    {
        ...
        compound.putInt("PetInvolveTimerDark", this.involveTimer);
    ...
    public void readAdditionalSaveData(CompoundTag compound) 
    {
        ...
        this.involveTimer = compound.getInt("PetInvolveTimerDark");
        this.deathTicks = compound.getInt("PetDeathTicks");
    }
    
    public float getFloatingRotation()
    {
        return -4.0F - Math.abs((float)Math.sin(this.floatingRotation) * 2.5F);
    }
}
