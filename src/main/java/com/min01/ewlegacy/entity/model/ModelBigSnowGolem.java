...
public class ModelBigSnowGolem extends HierarchicalModel<EntityBigSnowGolem> 
{
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(ElementalWitchesLegacy.MODID, "big_snow_golem"), "main");
	...
	public ModelBigSnowGolem(ModelPart p_170697_) 
	{
		this.root = p_170697_;
	...
	@Override
	public void setupAnim(EntityBigSnowGolem p_102962_, float p_102963_, float p_102964_, float p_102965_, float p_102966_, float p_102967_)
	{
	...
	@Override
	public void prepareMobModel(EntityBigSnowGolem p_102957_, float p_102958_, float p_102959_, float p_102960_) 
	{
		...
		{
			int j = p_102957_.getHoldRoseTick();
			if(j > 0) 
			{
