...
public class ModelElementalWitch<T extends Entity> extends VillagerModel<T> 
{
	private boolean holdingItem;

	public ModelElementalWitch(ModelPart p_171055_)
	{
		super(p_171055_);
	}
	...
	public void setupAnim(T p_104067_, float p_104068_, float p_104069_, float p_104070_, float p_104071_, float p_104072_)
	{
		...
		this.root().getChild("head").getChild("hat").getChild("hat_rim").visible = false;
