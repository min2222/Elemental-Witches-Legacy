...
public class ModelFireBat extends HierarchicalModel<EntityFireBat> 
{
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(ElementalWitchesLegacy.MODID, "fire_bat"), "main");
	...
	public ModelFireBat(ModelPart p_170427_) 
	{
		this.root = p_170427_;
	...
	@Override
	public void setupAnim(EntityFireBat p_102200_, float p_102201_, float p_102202_, float p_102203_, float p_102204_, float p_102205_) 
	{
