...
public class EntityWaterShot extends AbstractEWHurtingProjectile
{
    public EntityWaterShot(EntityType<? extends AbstractEWHurtingProjectile> type, Level level)
    {
        super(type, level);
    }
    
    public EntityWaterShot(Level level, LivingEntity living, double x, double y, double z)
    {
        super(EWEntities.WATER_SHOT.get(), level, living, x,  y, z);
    }
    
    public EntityWaterShot(Level level, double x, double y, double z, double motionX, double motionY, double motionZ)
    {
        super(EWEntities.WATER_SHOT.get(), level, x, y, z, motionX, motionY, motionZ);
    }
