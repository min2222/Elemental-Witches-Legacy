...
public abstract class AbstractEWHurtingProjectile extends Projectile 
{
	public double xPower;
	public double yPower;
	public double zPower;

	protected AbstractEWHurtingProjectile(EntityType<? extends AbstractEWHurtingProjectile> p_36833_, Level p_36834_) 
	{
		super(p_36833_, p_36834_);
	}

	public AbstractEWHurtingProjectile(EntityType<? extends AbstractEWHurtingProjectile> p_36817_, Level p_36824_, double p_36818_, double p_36819_, double p_36820_, double p_36821_, double p_36822_, double p_36823_) 
	{
	...
	public AbstractEWHurtingProjectile(EntityType<? extends AbstractEWHurtingProjectile> p_36826_, Level p_36831_, LivingEntity p_36827_, double p_36828_, double p_36829_, double p_36830_) 
	{
		this(p_36826_, p_36831_, p_36827_.getX(), p_36827_.getY(), p_36827_.getZ(), p_36828_, p_36829_, p_36830_);
