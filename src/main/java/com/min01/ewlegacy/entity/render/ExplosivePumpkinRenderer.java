...
public class ExplosivePumpkinRenderer extends RenderLiving
{
    private static final ResourceLocation Pumpkin_Texture;
    
    public ExplosivePumpkinRenderer(final ModelBase par1ModelBase, final float par2) {
    ...
    protected ResourceLocation getEntityTexture(final Entity par1Entity) {
        return ExplosivePumpkinRenderer.Pumpkin_Texture;
    }
    
    static {
        Pumpkin_Texture = new ResourceLocation("mwaw:textures/entity/pumpkin.png");
    }
}
