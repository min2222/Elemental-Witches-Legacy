...
public class DarkSpirit3Renderer extends RenderLiving
{
    private static final ResourceLocation DarkPet3_Texture;
    
    public DarkSpirit3Renderer(final ModelBase par1ModelBase, final float par2) {
    ...
    protected void renderEquippedItems(final EntityDarkSpirit3 p_77029_1_, final float p_77029_2_) {
    ...
    protected int getColorMultiplier(final EntityDarkSpirit3 p_77030_1_, final float p_77030_2_, final float p_77030_3_) {
        final int f2 = p_77030_1_.deathTicks;
        return 10 << f2 + 225;
    }
    
    protected ResourceLocation getEntityTexture(final Entity par1Entity) {
        return DarkSpirit3Renderer.DarkPet3_Texture;
    }
    
    protected void renderEquippedItems(final EntityLivingBase p_77029_1_, final float p_77029_2_) {
        this.renderEquippedItems((EntityDarkSpirit3)p_77029_1_, p_77029_2_);
    }
    
    protected int getColorMultiplier(final EntityLivingBase p_77030_1_, final float p_77030_2_, final float p_77030_3_) {
        return this.getColorMultiplier((EntityDarkSpirit3)p_77030_1_, p_77030_2_, p_77030_3_);
    }
    
    static {
        DarkPet3_Texture = new ResourceLocation("mwaw:textures/entity/darkpet3.png");
    }
}
