...
public class RifleRenderer extends RenderLiving
{
    private static final ResourceLocation Rifle_Texture;
    
    public RifleRenderer(final ModelBase par1ModelBase, final float par2) {
    ...
    protected ResourceLocation getEntityTexture(final Entity par1Entity) {
        return RifleRenderer.Rifle_Texture;
    }
    
    static {
        Rifle_Texture = new ResourceLocation("mwaw:textures/entity/rifle.png");
    }
}
