...
public class FireDragon3Renderer extends RenderLiving
{
    private static final ResourceLocation FirePet3_Texture;
    
    public FireDragon3Renderer(final ModelBase par1ModelBase, final float par2) {
    ...
    protected int shouldRenderPass(final EntityFireDragon3 p_77032_1_, final int p_77032_2_, final float p_77032_3_) {
        if (p_77032_2_ == 0) {
            this.bindTexture(FireDragon3Renderer.FirePet3_Texture);
    ...
    protected void renderEquippedItems(final EntityFireDragon3 p_77029_1_, final float p_77029_2_) {
    ...
    protected int getColorMultiplier(final EntityFireDragon3 p_77030_1_, final float p_77030_2_, final float p_77030_3_) {
        final int f2 = p_77030_1_.deathTicks;
        return 10 << f2 + 225;
    }
    
    protected ResourceLocation getEntityTexture(final Entity par1Entity) {
        return FireDragon3Renderer.FirePet3_Texture;
    }
    
    protected void renderEquippedItems(final EntityLivingBase p_77029_1_, final float p_77029_2_) {
        this.renderEquippedItems((EntityFireDragon3)p_77029_1_, p_77029_2_);
    }
    
    protected int getColorMultiplier(final EntityLivingBase p_77030_1_, final float p_77030_2_, final float p_77030_3_) {
        return this.getColorMultiplier((EntityFireDragon3)p_77030_1_, p_77030_2_, p_77030_3_);
    }
    
    static {
        FirePet3_Texture = new ResourceLocation("mwaw:textures/entity/firepet3.png");
    }
}
