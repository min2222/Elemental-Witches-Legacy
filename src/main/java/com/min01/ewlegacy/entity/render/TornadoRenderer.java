...
public class TornadoRenderer extends RenderLiving
{
    private static final ResourceLocation Tornado_Texture;
    
    public TornadoRenderer(final ModelBase par1ModelBase, final float par2) {
    ...
    protected ResourceLocation getEntityTexture(final Entity par1Entity) {
        return TornadoRenderer.Tornado_Texture;
    }
    
    static {
        Tornado_Texture = new ResourceLocation("mwaw:textures/entity/lightninggolem.png");
    }
}
