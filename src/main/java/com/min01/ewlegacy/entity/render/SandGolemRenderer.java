...
public class SandGolemRenderer extends RenderLiving
{
    private static final ResourceLocation Sandstone_Texture;
    private static final ResourceLocation armoredblitsuneTextures;
    private ModelBase witchModel;
    
    public SandGolemRenderer() {
        super((ModelBase)new ModelSandGolem(), 0.5f);
        this.witchModel = (ModelBase)new ModelSandGolem();
    }
    ...
    protected ResourceLocation getEntityTexture(final Entity par1Entity) {
        return SandGolemRenderer.Sandstone_Texture;
    }
    
    protected int shouldRenderPass(final EntitySandGolem p_77032_1_, final int p_77032_2_, final float p_77032_3_) {
        ...
        if (p_77032_2_ == 1) {
            ...
            this.bindTexture(SandGolemRenderer.armoredblitsuneTextures);
    ...
    protected int inheritRenderPass(final EntitySandGolem p_77035_1_, final int p_77035_2_, final float p_77035_3_) {
        return -1;
    }
    
    protected int shouldRenderPass(final EntityLivingBase p_77032_1_, final int p_77032_2_, final float p_77032_3_) {
        return this.shouldRenderPass((EntitySandGolem)p_77032_1_, p_77032_2_, p_77032_3_);
    }
    
    protected int inheritRenderPass(final EntityLivingBase p_77035_1_, final int p_77035_2_, final float p_77035_3_) {
        return this.inheritRenderPass((EntitySandGolem)p_77035_1_, p_77035_2_, p_77035_3_);
    }
    
    static {
        Sandstone_Texture = new ResourceLocation("mwaw:textures/entity/sandstone.png");
