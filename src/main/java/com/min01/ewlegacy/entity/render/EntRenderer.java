...
public class EntRenderer extends RenderLiving
{
    ...
    public EntRenderer(final ModelBase par1ModelBase, final float par2) {
    ...
    protected ResourceLocation getEntityTexture(final Entity par1Entity) {
        return EntRenderer.Ent_Texture;
    }
    
    static {
        Ent_Texture = new ResourceLocation("mwaw:textures/entity/ent.png");
    }
}
