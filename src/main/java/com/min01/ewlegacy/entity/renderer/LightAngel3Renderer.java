...
public class LightAngel3Renderer extends EWMobRenderer<EntityLightAngel3, ModelLightAngel3>
{
	private static final float HALF_SQRT_3 = (float)(Math.sqrt(3.0D) / 2.0D);
	   
	public LightAngel3Renderer(Context p_174304_)
	{
		super(p_174304_, new ModelLightAngel3(p_174304_.bakeLayer(ModelLightAngel3.LAYER_LOCATION)), 0.5F, "light_angel_3");
	}
	
	@Override
	protected void scale(EntityLightAngel3 p_115314_, PoseStack p_115315_, float p_115316_) 
	{
		p_115315_.scale(0.7F, 0.7F, 0.7F);
		p_115315_.translate(0.0F, 0.3F, 0.0F);
	}

	@Override
	public void render(EntityLightAngel3 p_115455_, float p_115456_, float p_115457_, PoseStack p_115458_, MultiBufferSource p_115459_, int p_115460_) 
	{
	...
	{
		p_114220_.vertex(p_114221_, 0.0F, 0.0F, 0.0F).color(255, 255, 102, p_114222_).endVertex();
	}

	private static void vertex2(VertexConsumer p_114215_, Matrix4f p_114216_, float p_114217_, float p_114218_)
	{
		p_114215_.vertex(p_114216_, -HALF_SQRT_3 * p_114218_, p_114217_, -0.5F * p_114218_).color(255, 255, 102, 0).endVertex();
	}

	private static void vertex3(VertexConsumer p_114224_, Matrix4f p_114225_, float p_114226_, float p_114227_)
	{
		p_114224_.vertex(p_114225_, HALF_SQRT_3 * p_114227_, p_114226_, -0.5F * p_114227_).color(255, 255, 102, 0).endVertex();
	}

	private static void vertex4(VertexConsumer p_114229_, Matrix4f p_114230_, float p_114231_, float p_114232_) 
	{
		p_114229_.vertex(p_114230_, 0.0F, p_114231_, 1.0F * p_114232_).color(255, 255, 102, 0).endVertex();
	}
}
