...
public class AirPhoenix3Renderer extends EWMobRenderer<EntityAirPhoenix3, ModelAirPhoenix3>
{
	private static final float HALF_SQRT_3 = (float)(Math.sqrt(3.0D) / 2.0D);
	   
	public AirPhoenix3Renderer(Context p_174304_)
	{
		super(p_174304_, new ModelAirPhoenix3(p_174304_.bakeLayer(ModelAirPhoenix3.LAYER_LOCATION)), 0.5F, "air_phoenix_3");
		this.addLayer(new AirPhoenix3Layer(this, p_174304_.getModelSet()));
	}

	@Override
	public void render(EntityAirPhoenix3 p_115455_, float p_115456_, float p_115457_, PoseStack p_115458_, MultiBufferSource p_115459_, int p_115460_) 
	{
	...
	{
		p_114215_.vertex(p_114216_, -HALF_SQRT_3 * p_114218_, p_114217_, -0.5F * p_114218_).color(255, 255, 255, 0).endVertex();
	}

	private static void vertex3(VertexConsumer p_114224_, Matrix4f p_114225_, float p_114226_, float p_114227_)
	{
		p_114224_.vertex(p_114225_, HALF_SQRT_3 * p_114227_, p_114226_, -0.5F * p_114227_).color(255, 255, 255, 0).endVertex();
	}

	private static void vertex4(VertexConsumer p_114229_, Matrix4f p_114230_, float p_114231_, float p_114232_) 
	{
		p_114229_.vertex(p_114230_, 0.0F, p_114231_, 1.0F * p_114232_).color(255, 255, 255, 0).endVertex();
	}
}
