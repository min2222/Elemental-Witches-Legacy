...
public class EarthGolem3Renderer extends EWMobRenderer<EntityEarthGolem3, ModelEarthGolem3>
{
	private static final float HALF_SQRT_3 = (float)(Math.sqrt(3.0D) / 2.0D);
	   
	public EarthGolem3Renderer(Context p_174304_)
	{
		super(p_174304_, new ModelEarthGolem3(p_174304_.bakeLayer(ModelEarthGolem3.LAYER_LOCATION)), 0.5F, "earth_golem_3");
		this.addLayer(new EarthGolem3Layer(this, p_174304_.getModelSet()));
	}

	@Override
	public void render(EntityEarthGolem3 p_115455_, float p_115456_, float p_115457_, PoseStack p_115458_, MultiBufferSource p_115459_, int p_115460_) 
	{
	...
	{
		p_114220_.vertex(p_114221_, 0.0F, 0.0F, 0.0F).color(139, 69, 19, p_114222_).endVertex();
	}

	private static void vertex2(VertexConsumer p_114215_, Matrix4f p_114216_, float p_114217_, float p_114218_)
	{
		p_114215_.vertex(p_114216_, -HALF_SQRT_3 * p_114218_, p_114217_, -0.5F * p_114218_).color(139, 69, 19, 0).endVertex();
	}

	private static void vertex3(VertexConsumer p_114224_, Matrix4f p_114225_, float p_114226_, float p_114227_)
	{
		p_114224_.vertex(p_114225_, HALF_SQRT_3 * p_114227_, p_114226_, -0.5F * p_114227_).color(139, 69, 19, 0).endVertex();
	}

	private static void vertex4(VertexConsumer p_114229_, Matrix4f p_114230_, float p_114231_, float p_114232_) 
	{
		p_114229_.vertex(p_114230_, 0.0F, p_114231_, 1.0F * p_114232_).color(139, 69, 19, 0).endVertex();
	}
}
