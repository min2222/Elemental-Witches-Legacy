...
public class FireDragon3Renderer extends EWMobRenderer<EntityFireDragon3, ModelFireDragon3>
{
	private static final float HALF_SQRT_3 = (float)(Math.sqrt(3.0D) / 2.0D);
	   
	public FireDragon3Renderer(Context p_174304_)
	{
		super(p_174304_, new ModelFireDragon3(p_174304_.bakeLayer(ModelFireDragon3.LAYER_LOCATION)), 0.5F, "fire_dragon_3");
		this.addLayer(new FireDragon3Layer(this, p_174304_.getModelSet()));
	}
	
	@Override
	protected void scale(EntityFireDragon3 p_115314_, PoseStack p_115315_, float p_115316_) 
	{
		p_115315_.translate(0.0F, 0.0F, -1.5F);
	}

	@Override
	public void render(EntityFireDragon3 p_115455_, float p_115456_, float p_115457_, PoseStack p_115458_, MultiBufferSource p_115459_, int p_115460_) 
	{
	...
	{
		p_114220_.vertex(p_114221_, 0.0F, 0.0F, 0.0F).color(255, 0, 0, p_114222_).endVertex();
	}

	private static void vertex2(VertexConsumer p_114215_, Matrix4f p_114216_, float p_114217_, float p_114218_)
	{
		p_114215_.vertex(p_114216_, -HALF_SQRT_3 * p_114218_, p_114217_, -0.5F * p_114218_).color(255, 0, 0, 0).endVertex();
	}
	...
	{
		p_114229_.vertex(p_114230_, 0.0F, p_114231_, 1.0F * p_114232_).color(255, 0, 0, 0).endVertex();
	}
}
