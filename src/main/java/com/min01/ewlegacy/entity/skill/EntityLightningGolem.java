...
public class EntityLightningGolem extends AbstractOwnableMonster<EntityLightningWitch>
{
    public EntityLightningGolem(EntityType<? extends Monster> type, Level level) 
    {
        super(type, level);
    ...
    {
    	return EWSounds.LIGHTNING.get();
    }
    
    @Override
    public boolean hurt(DamageSource source, float damage) 
    {
        return !(source.getEntity() instanceof LightningBolt) && !(source.getEntity() instanceof EntityLightningWitch) && super.hurt(source, damage);
    }
