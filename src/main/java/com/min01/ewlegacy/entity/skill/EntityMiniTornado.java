...
public class EntityMiniTornado extends AbstractOwnableMonster<EntityAirWitch>
{
    public EntityMiniTornado(EntityType<? extends Monster> type, Level level) 
    {
        super(type, level);
        this.noCulling = true;
    ...
    public void aiStep()
    {
        ...
        for(Entity entitytargetcheck : targetList) 
        {
            ...
            {
                entitytargetcheck.hurt(DamageSource.MAGIC, 0.5F);
            }
        }
